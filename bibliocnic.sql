...
--
-- Host: localhost
-- Generation Time: Jun 15, 2011 at 10:57 
...
CREATE TABLE IF NOT EXISTS `busqueda` (
  ...
  `tematicas` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `busqueda` (`id`, `user_id`, `titulo`, `mensaje`, `is_active`, `created_at`, `updated_at`, `tematica`, `tematicas`, `fecha_antes`, `fecha_despues`) VALUES
(2, 1, 'prueba1', 'hello esta e s mi primera prueba', 1, '2011-05-06 22:43:00', '2011-05-06 22:44:00', NULL, 'FISICA', '2007-01-03 01:04:00', '2010-03-04 03:02:00'),
(3, 1, 'prueba2', 'esta vez espero llegue bien', 1, '2011-06-08 15:21:00', '2011-06-08 15:21:00', NULL, 'FISICA', '2006-01-19 17:17:00', '2008-10-15 16:14:00'),
(4, NULL, 'prueba3', 'con unset', 1, '2012-07-15 15:14:00', '2012-10-15 13:14:00', NULL, 'FISICA', NULL, NULL),
(5, NULL, 'veremos si no pone el updated at', 'adfdfadfadfadfaf', 0, '2011-06-08 16:56:34', '2011-06-08 16:56:34', NULL, 'FISICA', NULL, NULL),
(6, 1, 'Necesito literatura rusa', 'Donde puedo encontrarla', 1, '2011-06-09 08:41:45', '2011-06-09 08:41:45', NULL, 'ARTE Y HUMANIDADES', '2010-01-06 00:00:00', '2011-08-08 00:00:00'),
(7, 1, 'buscar libro', 'es una revistaasasdasdasdasd', 1, '2011-06-09 20:52:54', '2011-06-09 20:52:54', NULL, 'MATEMATICA', '2007-02-02 00:00:00', '2009-02-15 00:00:00'),
(8, 1, 'Necesito literatura japonesa', 'Necesito cualquier tipo de literatura que hable de los samurais, pespecíficamente de li li lan', 1, '2011-06-10 10:51:43', '2011-06-10 10:51:43', NULL, 'MATEMATICA', NULL, NULL),
(9, 1, 'probando las felciitaciones', 'realmente no necesito un libro :)', 1, '2011-06-10 11:07:29', '2011-06-10 11:07:29', NULL, 'MATEMATICA', NULL, NULL),
(10, 1, 'probando las felciitaciones', 'realmente no necesito un libro :)', 1, '2011-06-10 11:07:47', '2011-06-10 11:07:47', NULL, 'MATEMATICA', NULL, NULL),
(11, 1, 'sdfsdfsdfsdfsdf', 'sdfsdfsfsdfsfsfsfsfsfsfsfsdfsfdfs', 1, '2011-06-10 11:12:33', '2011-06-10 11:12:33', NULL, 'FISICA', NULL, NULL),
(12, 1, 'asdfadfadfasdfadfasdfadfadf', 'asdfasdfadfasdfasdfadsfafasdfadfd', 1, '2011-06-15 22:05:49', '2011-06-15 22:05:49', NULL, 'MATEMATICA', '1902-01-01 00:00:00', '1918-01-19 00:00:00');
...
(4, 1, 'admin', 'dmGroupAdmin', 'new', 0, 1308171460, 'admin', '/admin.php/system/security/groups/new', 'es');
...
(1, 'f6587675a5bd25a0134229cc99c64fd4', '127.0.0.5', '2011-06-12 19:04:59');
...
INSERT INTO `dm_user` (`username`, `email`, `algorithm`, `salt`, `password`, `is_active`, `is_super_admin`, `last_login`, `forgot_password_code`, `id`, `titulo`, `nombre`, `apellidos`, `foto_id`, `penalizado`, `created_at`, `updated_at`, `solapin`, `departamento`) VALUES
('admin', 'admin@bibliocnic.com', 'sha1', '20145d874137f0b47716601f40edba0e', '86e615de7ddd0b9f01f522cfcc70e7d9b336478e', 1, 1, '2011-06-15 22:50:51', NULL, 1, NULL, '', '', NULL, 0, '2011-06-05 16:30:32', '2011-06-05 16:30:32', NULL, NULL);
...
ALTER TABLE `prestamo`
  ADD CONSTRAINT `prestamo_dm_user_id_dm_user_id` FOREIGN KEY (`user_id`) REFERENCES `dm_user` (`id`),
