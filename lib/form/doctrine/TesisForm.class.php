...
class TesisForm extends BaseTesisForm
{
  ...
  {
   parent::configure();
  $this->useFields(array('titulo', 'anno', 'resumen', 'idioma', 'palabras_claves', 'tipo', 'total_paginas', 'ciudad', 'tutor', 'institucion', 'departamento', 'autors_list', 'slide_id_form'));
  ...
  $this->validatorSchema['tutor'] = new sfValidatorString(array('min_length' =>5, 'required' => true), array ('required'=>'Por favor inserte el tutor', 'min_length' => 'El tutor debe tener al menos 5 caracteres'));
